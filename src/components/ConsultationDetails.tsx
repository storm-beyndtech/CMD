...
export default function ConsultationDetails({ consultation }: any) {
  ...
  return (
    <>
        ...
        <div className="flex items-start gap-4 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-[#5D6679] mt-1 flex items-center gap-2 mb-2">
              ...
              Consultation, {consultation.appointmentTime}
            </p>
      ...
      <div>
        <LabResults
          lastVisit={consultations[0].lastVisit}
          remarks={consultations[0].remarks}
          tests={consultations[0].tests}
          uploads={consultations[0].uploads}
        />
      </div>
    </>
  );
