...
export default function ConsultationCard({ patientName, appointmentTime, meetingLink, imageUrl }: any) {
					...
					<div className="flex items-start sm:gap-4 gap-2">
						<div className="flex flex-col gap-2">
							<h2 className="text-lg font-semibold text-[#383E49] flex items-center justify-between">
								Consultation with {patientName} <img src={imageUrl} alt="patient" className="w-6 h-6 ml-5" />
							</h2>
