...
export default function PatientAuth() {
	...
	return (
		<div className="flex min-h-screen bg-primary">
			{/* Right: Form Content */}
			<FormLayout activeTab={activeTab} setActiveTab={setActiveTab} page="partner" error={error}>
				<AuthForm
			...
			<div className="hidden md:flex justify-end w-[40%]">
				<img src={drHoldingPatient} alt="auth" className="w-auto h-screen fixed top-0 right-0" />
			</div>
		</div>
	);
}
